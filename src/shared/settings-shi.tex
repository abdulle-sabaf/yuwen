...
\setCJKfamilyfont{xuwen}{KaiTi} % 定义序文字体
\newcommand{\xuwen}{\CJKfamily{xuwen}} % 创建一个 \beishu 命令，方便调用
\setCJKfamilyfont{beishu}{KingHwaOldSong} % 定义背诵框字体
...
% 背诵框命令
\newcommand{\beisong}[1]{
    \begin{textblock*}{14mm}(15mm, 13mm)   % 宽 30mm，左上角在 (15mm, 13mm)  
