...
- 《[中学文言文课文集萃](./语文/中学古文阅读课文集萃.pdf)》：中学阶段学习文言文的阅读文章。主要搜集已经选入过课本的文言文，少数是我们另外选入的文章。目前一共82篇。
...
完成品主要是前一节提到的课文集萃，包括识字课文、小学与中学的课文集萃。其中搜集了从50年代起至今编入各个版本语文教科书的大量中小学课文。识字课文包括至少70篇课文，识字量为600字左右，学完之后可以衔接小学的语文学习。小学课文包括180篇现代文，中学课文包括140篇现代文和82篇文言文。此外包括108篇初阶（学龄前和小学阶段）经典古诗以及约100篇古体诗词（中学阶段）。
